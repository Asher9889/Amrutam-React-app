...
const Footer = () => {
  return (
    <div className="bg-[#DCE3DC] flex flex-col gap-4 p-16">
      <div className="lg:hidden flex flex-col w-60  mx-auto items-start justify-center font-dinProRegular gap-4">
      ...
      <div className="flex  flex-col gap-2 w-60 items-start mx-auto  justify-center">
      ...
      <div className="lg:hidden w-60 mx-auto">
        <p className="font-dinPro text-[var(--green-color)] text-lg">Subscribe to our Newsletter and join Amrutam Family today!</p>
        <div className=" h-10 flex  mt-4 rounded-full">
          <input className="h-full w-28  h-8 text-xs rounded-l-full outline-none px-3" placeholder="Your Email Address" type="text" />
          <button className="h-full rounded-r-full pr-4 h-8 bg-black pl-2 font-dinPro text-white">Subscribe</button>
        </div>
      </div>
    </div>
  );
